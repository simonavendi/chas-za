    ...
    <div className="bg-bg-light min-h-full font-rubik">
      ...
      <div className="bg-white flex justify-between items-center px-5 pt-10 pb-2">
        ...
        <div className="flex gap-1 items-center">
          <svg width="17" height="11" viewBox="0 0 17 11" fill="none"><rect x="0" y="0" width="17" height="2" rx="1" fill="#2a2b2a" /><rect x="0" y="4.5" width="17" height="2" rx="1" fill="#2a2b2a" /><rect x="0" y="9" width="17" height="2" rx="1" fill="#2a2b2a" /></svg>
        </div>
      </div>
      ...
      <div className="bg-white px-4 pb-3">
        <div className="flex items-center bg-bg-light rounded-xl px-4 h-11 gap-3 border border-gray-100">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="7" cy="7" r="5" stroke="#C7CBCF" strokeWidth="1.5" /><line x1="11" y1="11" x2="15" y2="15" stroke="#C7CBCF" strokeWidth="1.5" strokeLinecap="round" /></svg>
      ...
      <div className="px-4 py-2 bg-white flex items-center gap-1 border-b border-gray-100">
        <svg width="11" height="13" viewBox="0 0 11 13" fill="none"><path d="M5.5 0C3.01 0 1 2.01 1 4.5C1 7.88 5.5 13 5.5 13C5.5 13 10 7.88 10 4.5C10 2.01 7.99 0 5.5 0ZM5.5 6C4.67 6 4 5.33 4 4.5C4 3.67 4.67 3 5.5 3C6.33 3 7 3.67 7 4.5C7 5.33 6.33 6 5.5 6Z" fill="#6FDB45" /></svg>
